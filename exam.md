...
Понял, давайте пересмотрим вопрос с новой таблицей `hobby` и правильным пояснением:
...
Извините за путаницу. Давайте пересмотрим вопрос с правильными данными.
...
Понял, давайте пересмотрим данные и запрос. Вот как должны быть правильно возвращены данные и результаты запроса.
...
Понял, давайте пересмотрим вопрос с новой таблицей `hobby` и правильным разбором.
